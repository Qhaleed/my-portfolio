...
export default function ({ label, rotate, href, src }: CardProps) {
  return (
    <main
     ...
     bg-white border border-gray-300 shadow-md hover:shadow-lg transition-shadow duration-300
     
        ${rotate === "left" ? "-rotate-10 sm:-rotate-3 lg:-rotate-5" : ""}
        ${rotate === "right" ? "rotate-10 sm:rotate-3 lg:rotate-5" : ""}
     
     `}
    >
      <div className="flex flex-col h-50 px-2 sm:px-3 lg:px-6 py-3 sm:py-4 lg:py-6 justify-between items-center">
